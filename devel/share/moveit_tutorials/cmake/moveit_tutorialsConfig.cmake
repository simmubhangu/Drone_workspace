...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/simmu/drone_ws/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/simmu/drone_ws/devel)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /home/simmu/drone_ws/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simmu/drone_ws/src/moveit_tutorials/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/simmu/drone_ws/devel/lib;/home/simmu/drone_ws/devel/lib;/home/simmu/Documents/catkin_ws/devel/lib;/opt/ros/indigo/lib)
